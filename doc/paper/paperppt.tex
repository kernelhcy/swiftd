...
\frame[containsverbatim]{
	\frametitle{连接处理的状态机}
	\begin{block}{}
	状态机的关键函数就是下面的connection\_state\_machine函数。
	\end{block}
	{\scriptsize
	\begin{verbatim}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.4\textwidth}
			...
			\begin{figure}[htbp]
			\centering
			\includegraphics[height=3cm, width=4.5cm]{startup.eps}
			\end{figure}
			\end{block}
		\end{column}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{figure}[htbp]
			\centering
			\includegraphics[height=5cm, width=6cm]{works.eps}
			\end{figure}
			\end{block}
		\end{column}
	\end{columns}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{figure}[htbp]
			\centering
			\includegraphics[height=3cm, width=4.5cm]{complugin.eps}
			\end{figure}
			\end{block}
		\end{column}
	...
	\begin{figure}[htbp]
	\centering
	\includegraphics[height=3cm, width=6cm]{nodirindex.eps}
	\end{figure}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{figure}[htbp]
			\centering
			\includegraphics[height=3cm, width=4.5cm]{uncomplugin.eps}
			\end{figure}
			\end{block}
		\end{column}
	...
	\begin{figure}[htbp]
	\centering
	\includegraphics[height=3cm, width=6cm]{dirindex.eps}
	\end{figure}
	\end{block}
\end{frame}
\begin{frame}
