...
\subsection{plugins\_call\_init函数}
...
\subsection{宏PLUGIN\_TO\_SLOT(x, y)}
整个函数中，这个宏是重点：
...
\subsection{枚举PLUGIN\_FUNC\_SIZEOF}
\begin{verbatim}
typedef enum 
{
	PLUGIN_FUNC_UNSET,
