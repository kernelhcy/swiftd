...
int config_setdefaults(server *srv)
{
	...
	srv -> srvconf.errorlog_file = buffer_init_string("/home/hcy/tmp/swiftd/swiftd.log");
	srv -> srvconf.errorlog_use_syslog = 0;
	srv -> srvconf.dont_daemonize = 0;
	srv -> srvconf.changeroot = buffer_init_string("/");
	srv -> srvconf.docroot = buffer_init_string("/home/hcy/tmp/swiftd/swiftdtest/");
	...
	//用于判断超时。
	srv -> srvconf.max_read_idle = 30;
	srv -> srvconf.max_write_idle = 30;
	srv -> srvconf.max_close_idle = 10;
	
	srv -> srvconf.plugin_conf_file = buffer_init_string("/home/hcy/tmp/swiftd/plugins/swiftd-plugin.conf");
